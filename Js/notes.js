...
function renderNotes() {
    ...
    notesContainer.innerHTML = notes.map(note => `
        ...
        <svg fill="#ECF2DF" height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
			...
			<path d="M323.658,263.766l75.435-75.435c8.333-8.333,8.331-21.843-0.004-30.173l-45.269-45.248
				...
				C323.643,263.778,323.651,263.773,323.658,263.766z M338.744,158.166l15.09,15.083l-45.24,45.24l-15.077-15.084L338.744,158.166z
				 M66.585,460.497l-15.079-15.079l211.808-211.827l15.088,15.088L66.585,460.497z"/>			<path d="M490.663,149.333h-42.667c-11.782,0-21.333,9.551-21.333,21.333c0,11.782,9.551,21.333,21.333,21.333h42.667
            ...
            <button class="delete-btn" onclick="deleteNote('${note.id}')" title="delete Note">
                <svg fill="#ECF2DF" height="30px" width="30px"viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    //ensimmäisenä tarkistaa, onko dark theme tallennettu muistiin
    //jos on, niin vaihtaa sen
    applyStoredTheme()
